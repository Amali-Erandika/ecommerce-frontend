...
const ChatSeller = () => {
  ...
  return (
    <div className="px-2 lg:px-7 py-5">
      <div className="w-full bg-[#283046] px-4 py-4 rounded-md h-[calc(100vh-148px)]">
        <div className="flex w-full h-full relative">
          ...
          >
            <div className="w-full h-[calc(100vh-177px)] bg-[#252b3b] md:bg-transparent overflow-y-auto">
              ...
              <div
                className={
                  "h-[60px] flex justify-start gap-2 items-center text-white px-2 py-2 rounded-sm cursor-pointer bg-slate-700"
                }
              >
              ...
              <div
                className={
                  "h-[60px] flex justify-start gap-2 items-center text-white px-2 py-2 rounded-sm cursor-pointer"
                }
              >
                <div className="relative">
                  <img
          ...
          <div className="w-full md:w-[calc(100%-200px)] md:pl-4">
              ...
              <div className="bg-slate-800 h-[calc(100vh-290px)] rounded-md p-3 overflow-y-auto">
                <div className="w-full flex justify-start items-center">
                  <div className="flex justify-end items-start gap-2 md:px-3 py-2 max-w-full lg:max-w-[85%]">
                    <div>
                      <img
                        className="w-[35px] h-[38px] border-2 border-white rounded-full max-w-[38px] p-[3px]"
                        src="http://localhost:3000/images/admin.png"
                        alt=""
                      />
                    </div>
            ...
            <form className=" flex gap-3">
              <input
                className="w-full flex justify-between px-2 border border-slate-700 item-center focus:border-blue-500 rounded-md outline-none bg-transparent text-[#d0d2d6]"
                type="text"
